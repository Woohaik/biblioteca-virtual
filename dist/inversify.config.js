...
var UserService_1 = require("./App/Services/UserService");
var BookService_1 = require("./App/Services/BookService");
var BookingService_1 = require("./App/Services/BookingService");
var connection_1 = require("./Data/connection");
var UserRepository_1 = require("./Data/Repositories/UserRepository");
var BookRepository_1 = require("./Data/Repositories/BookRepository");
var BookingRepository_1 = require("./Data/Repositories/BookingRepository");
exports.bindings = new inversify_1.AsyncContainerModule(function (bind) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, connection_1.getDbConnection()];
            case 1:
                _a.sent();
