...
var BookingDto_1 = require("../Dtos/BookingDto");
var BookingController = (function () {
    function BookingController(bookingService) {
        this.bookingService = bookingService;
    }
    BookingController.prototype.getBookings = function (_) {
        return __awaiter(this, void 0, void 0, function () {
            var bookings, mappedBookings;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.bookingService.getAllBookings()];
                    case 1:
                        bookings = _a.sent();
    ...
    BookingController.prototype.addBooking = function (_, newBooking) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(newBooking);
                        return [4, this.bookingService.addBooking(1, 1)];
                    case 1:
                        _a.sent();
                        return [2, new ResponseDto_1.ResponseDto([], {
