...
var BookRepository = (function () {
    ...
    BookRepository.prototype.delete = function (id) {
        console.log(id);
        throw new Error("Method not implemented.");
    };
    BookRepository.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.bookConnection.findOne(id)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    };
    BookRepository.prototype.save = function (entity) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    BookRepository.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.bookConnection.find()];
                    case 1: return [2, _a.sent()];
                }
            });
        });
